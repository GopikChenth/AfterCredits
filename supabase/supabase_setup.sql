-- Create profiles table (SWAPPED: username = real name, display_name = gamertag)
CREATE TABLE profiles (
  ...
  use_display_name BOOLEAN DEFAULT false, -- Privacy toggle: true = show gamertag, false = show real name
  avatar_url TEXT,
