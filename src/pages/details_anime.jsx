    ...
    const recommendations =
      data.recommendations?.nodes
        ...
        ?.map((node) => ({
          ...
          subtitle:
            node.mediaRecommendation.genres?.slice(0, 3).join(", ") || "",
      ...
      <View style={styles.container}>
        ...
        <View style={styles.errorContainer}>
          ...
          <Pressable
            style={[
              styles.retryButton,
              { marginTop: 10, backgroundColor: "#A0A0A0" },
            ]}
                      ...
                      <View style={styles.paginationContainer}>
                        ...
                        >
                          ...
                          <Ionicons
                            ...
                            size={20}
                            color={
                              currentReviewPage === totalPages ? "#666" : "#fff"
                            }
                          />
                        </Pressable>
                      </View>
          ...
          {animeData.recommendations && animeData.recommendations.length > 0 ? (
            <FlatList
              ...
              renderItem={({ item }) => (
                <Pressable
                  onPress={() =>
                    navigation?.push("DetailsAnime", { animeId: item.id })
                  }
                  style={({ pressed }) => [
                    styles.relatedCard,
